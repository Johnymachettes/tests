...
export function getSupabaseClient(): SupabaseClient & { supabaseUrl: string; supabaseKey: string } {
  if (!supabaseClient) {
...
export function setSupabaseSession(accessToken: string, refreshToken: string): void {
